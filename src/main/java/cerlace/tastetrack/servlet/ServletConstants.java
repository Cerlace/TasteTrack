...
public class ServletConstants {
    ...
    public static final String INGREDIENT_LIST_JSP = "/list-ingredient.jsp";
    public static final String INGREDIENT_SAVE_JSP = "/save-ingredient.jsp";
    public static final String INGREDIENT_UPDATE_JSP = "/update-ingredient.jsp";
    ...
    public static final String DISH_LIST_JSP = "/list-dish.jsp";
    public static final String DISH_SAVE_JSP = "/save-dish.jsp";
    public static final String DISH_UPDATE_JSP = "/update-dish.jsp";
    ...
    public static final String MEAL_LIST_JSP = "/list-meal.jsp";
    public static final String MEAL_SAVE_JSP = "/save-meal.jsp";
    public static final String MEAL_UPDATE_JSP = "/update-meal.jsp";
